...
export function BankHeader({ activeTab, onTabChange }: BankHeaderProps) {
  ...
  const handleLogout = async () => {
    if (confirm('Are you sure you want to securely log out of your Internet Banking session?')) {
      await logout();
  ...
  return (
    <header className="w-full select-none">
      ...
      {/* Primary Tab Navigation Ribbon (Classic OnlineSBI & HDFC style) */}
        ...
        {user ? (
          ...
          <>
            ...
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                alert('Current Domestic Term Deposit Rate: 7.10% p.a. (Senior Citizens: 7.60% p.a.)');
              }}
              className="bank-nav-tab"
            >
              📈 Interest Rates
            </a>
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                alert('Helpline: 1800-425-3800 / 1800-11-2211 | Cyber Fraud: 1930');
              }}
              className="bank-nav-tab"
            >
      ...
      {/* Classic Scrolling Announcement Marquee */}
